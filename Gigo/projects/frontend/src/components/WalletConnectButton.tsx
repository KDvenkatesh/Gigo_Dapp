  ...
  if (activeAddress) {
    return (
      <motion.button
        ...
        className="flex items-center gap-3 rounded-full border border-white/10 bg-black/40 px-4 py-2.5 text-sm font-medium text-white shadow-[0_18px_40px_rgba(0,0,0,0.28)] backdrop-blur-xl transition hover:bg-black/55"
      >
